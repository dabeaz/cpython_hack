...
static int init_identifiers(void)
{
    ...
    if ((state->__dict__ = PyString_InternFromString("__dict__")) == NULL) return 0;
    if ((state->__doc__ = PyString_InternFromString("__doc__")) == NULL) return 0;
    if ((state->__module__ = PyString_InternFromString("__module__")) == NULL) return 0;
    if ((state->_attributes = PyString_InternFromString("_attributes")) == NULL) return 0;
    if ((state->_fields = PyString_InternFromString("_fields")) == NULL) return 0;
    if ((state->arg = PyString_InternFromString("arg")) == NULL) return 0;
    if ((state->args = PyString_InternFromString("args")) == NULL) return 0;
    if ((state->asname = PyString_InternFromString("asname")) == NULL) return 0;
    if ((state->ast = PyString_InternFromString("ast")) == NULL) return 0;
    if ((state->attr = PyString_InternFromString("attr")) == NULL) return 0;
    if ((state->bases = PyString_InternFromString("bases")) == NULL) return 0;
    if ((state->body = PyString_InternFromString("body")) == NULL) return 0;
    if ((state->cause = PyString_InternFromString("cause")) == NULL) return 0;
    if ((state->col_offset = PyString_InternFromString("col_offset")) == NULL) return 0;
    if ((state->comparators = PyString_InternFromString("comparators")) == NULL) return 0;
    if ((state->context_expr = PyString_InternFromString("context_expr")) == NULL) return 0;
    if ((state->conversion = PyString_InternFromString("conversion")) == NULL) return 0;
    if ((state->ctx = PyString_InternFromString("ctx")) == NULL) return 0;
    if ((state->decorator_list = PyString_InternFromString("decorator_list")) == NULL) return 0;
    if ((state->defaults = PyString_InternFromString("defaults")) == NULL) return 0;
    if ((state->elt = PyString_InternFromString("elt")) == NULL) return 0;
    if ((state->elts = PyString_InternFromString("elts")) == NULL) return 0;
    if ((state->end_col_offset = PyString_InternFromString("end_col_offset")) == NULL) return 0;
    if ((state->end_lineno = PyString_InternFromString("end_lineno")) == NULL) return 0;
    if ((state->exc = PyString_InternFromString("exc")) == NULL) return 0;
    if ((state->finalbody = PyString_InternFromString("finalbody")) == NULL) return 0;
    if ((state->format_spec = PyString_InternFromString("format_spec")) == NULL) return 0;
    if ((state->func = PyString_InternFromString("func")) == NULL) return 0;
    if ((state->generators = PyString_InternFromString("generators")) == NULL) return 0;
    if ((state->handlers = PyString_InternFromString("handlers")) == NULL) return 0;
    if ((state->id = PyString_InternFromString("id")) == NULL) return 0;
    if ((state->ifs = PyString_InternFromString("ifs")) == NULL) return 0;
    if ((state->items = PyString_InternFromString("items")) == NULL) return 0;
    if ((state->iter = PyString_InternFromString("iter")) == NULL) return 0;
    if ((state->key = PyString_InternFromString("key")) == NULL) return 0;
    if ((state->keys = PyString_InternFromString("keys")) == NULL) return 0;
    if ((state->keywords = PyString_InternFromString("keywords")) == NULL) return 0;
    if ((state->kind = PyString_InternFromString("kind")) == NULL) return 0;
    if ((state->kw_defaults = PyString_InternFromString("kw_defaults")) == NULL) return 0;
    if ((state->kwarg = PyString_InternFromString("kwarg")) == NULL) return 0;
    if ((state->kwonlyargs = PyString_InternFromString("kwonlyargs")) == NULL) return 0;
    if ((state->left = PyString_InternFromString("left")) == NULL) return 0;
    if ((state->level = PyString_InternFromString("level")) == NULL) return 0;
    if ((state->lineno = PyString_InternFromString("lineno")) == NULL) return 0;
    if ((state->lower = PyString_InternFromString("lower")) == NULL) return 0;
    if ((state->module = PyString_InternFromString("module")) == NULL) return 0;
    if ((state->msg = PyString_InternFromString("msg")) == NULL) return 0;
    if ((state->name = PyString_InternFromString("name")) == NULL) return 0;
    if ((state->names = PyString_InternFromString("names")) == NULL) return 0;
    if ((state->op = PyString_InternFromString("op")) == NULL) return 0;
    if ((state->operand = PyString_InternFromString("operand")) == NULL) return 0;
    if ((state->ops = PyString_InternFromString("ops")) == NULL) return 0;
    if ((state->optional_vars = PyString_InternFromString("optional_vars")) == NULL) return 0;
    if ((state->orelse = PyString_InternFromString("orelse")) == NULL) return 0;
    if ((state->posonlyargs = PyString_InternFromString("posonlyargs")) == NULL) return 0;
    if ((state->right = PyString_InternFromString("right")) == NULL) return 0;
    if ((state->slice = PyString_InternFromString("slice")) == NULL) return 0;
    if ((state->step = PyString_InternFromString("step")) == NULL) return 0;
    if ((state->target = PyString_InternFromString("target")) == NULL) return 0;
    if ((state->targets = PyString_InternFromString("targets")) == NULL) return 0;
    if ((state->test = PyString_InternFromString("test")) == NULL) return 0;
    if ((state->type = PyString_InternFromString("type")) == NULL) return 0;
    if ((state->upper = PyString_InternFromString("upper")) == NULL) return 0;
    if ((state->value = PyString_InternFromString("value")) == NULL) return 0;
    if ((state->values = PyString_InternFromString("values")) == NULL) return 0;
    if ((state->vararg = PyString_InternFromString("vararg")) == NULL) return 0;
    return 1;
};
...
make_type(const char *type, PyObject* base, const char* const* fields, int num_fields, const char *doc)
{
    ...
    for (i = 0; i < num_fields; i++) {
        PyObject *field = PyString_InternFromString(fields[i]);
        if (!field) {
            Py_DECREF(fnames);
            return NULL;
        }
...
add_attributes(PyObject *type, const char * const *attrs, int num_fields)
{
    ...
    if (!l)
        return 0;
    for (i = 0; i < num_fields; i++) {
        s = PyString_InternFromString(attrs[i]);
        if (!s) {
            Py_DECREF(l);
            return 0;
        }
...
static int init_types(void)
{
    ...
    state->Assign_type = make_type("Assign", state->stmt_type, Assign_fields, 2,
        "Assign(expr* targets, expr value)");
...
static int obj2ast_mod(PyObject* obj, mod_ty* out);
static int obj2ast_stmt(PyObject* obj, stmt_ty* out);
static int obj2ast_expr(PyObject* obj, expr_ty* out);
static int obj2ast_expr_context(PyObject* obj, expr_context_ty* out);
static int obj2ast_boolop(PyObject* obj, boolop_ty* out);
static int obj2ast_operator(PyObject* obj, operator_ty* out);
static int obj2ast_unaryop(PyObject* obj, unaryop_ty* out);
static int obj2ast_cmpop(PyObject* obj, cmpop_ty* out);
static int obj2ast_comprehension(PyObject* obj, comprehension_ty* out);
static int obj2ast_excepthandler(PyObject* obj, excepthandler_ty* out);
static int obj2ast_arguments(PyObject* obj, arguments_ty* out);
static int obj2ast_arg(PyObject* obj, arg_ty* out);
static int obj2ast_keyword(PyObject* obj, keyword_ty* out);
static int obj2ast_alias(PyObject* obj, alias_ty* out);
static int obj2ast_withitem(PyObject* obj, withitem_ty* out);
...
stmt_ty
Pass(int lineno, int col_offset, int end_lineno, int end_col_offset)
{
    stmt_ty p;
    p = (stmt_ty)malloc(sizeof(*p));
    if (!p)
...
stmt_ty
Break(int lineno, int col_offset, int end_lineno, int end_col_offset)
{
    stmt_ty p;
    p = (stmt_ty)malloc(sizeof(*p));
    if (!p)
...
comprehension(expr_ty target, expr_ty iter, asdl_seq * ifs)
{
    ...
    if (!p)
        return (comprehension_ty) PyErr_NoMemory();
    p->target = target;
    p->iter = iter;
    p->ifs = ifs;
    return p;
              ...
              col_offset, int end_lineno, int end_col_offset)
{
    ...
    if (!p)
        return (excepthandler_ty) PyErr_NoMemory();
...
arguments(asdl_seq * posonlyargs, asdl_seq * args, arg_ty vararg, asdl_seq *
          kwonlyargs, asdl_seq * kw_defaults, arg_ty kwarg, asdl_seq * defaults)
{
    arguments_ty p;
    p = (arguments_ty)malloc(sizeof(*p));
    if (!p)
        return (arguments_ty) PyErr_NoMemory();
        ...
        end_lineno, int end_col_offset)
{
    ...
    if (!p)
        return (keyword_ty) PyErr_NoMemory();
    p->arg = arg;
    p->value = value;
    p->lineno = lineno;
    p->col_offset = col_offset;
...
alias(identifier name, identifier asname)
{
    ...
    if (!p)
        return (alias_ty) PyErr_NoMemory();
    p->name = name;
    p->asname = asname;
    return p;
}
...
withitem_ty
withitem(expr_ty context_expr, expr_ty optional_vars)
{
    withitem_ty p;
    if (!context_expr) {
        PyErr_SetString(PyExc_ValueError,
    ...
    if (!p)
        return (withitem_ty) PyErr_NoMemory();
...
int
obj2ast_mod(PyObject* obj, mod_ty* out)
{
    int isinstance;
...
int
obj2ast_stmt(PyObject* obj, stmt_ty* out)
{
    int isinstance;
    ...
    if (tmp == NULL || tmp == Py_None) {
        ...
        int res;
        res = obj2ast_int(tmp, &end_lineno);
        if (res != 0) goto failed;
        Py_CLEAR(tmp);
    }
    ...
    if (tmp == NULL || tmp == Py_None) {
        ...
        int res;
        res = obj2ast_int(tmp, &end_col_offset);
        if (res != 0) goto failed;
        Py_CLEAR(tmp);
    }
    ...
    if (isinstance) {
        ...
        *out = Pass(lineno, col_offset, end_lineno, end_col_offset);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Break(lineno, col_offset, end_lineno, end_col_offset);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Continue(lineno, col_offset, end_lineno, end_col_offset);
        if (*out == NULL) goto failed;
        return 0;
    }
...
int
obj2ast_expr(PyObject* obj, expr_ty* out)
{
    int isinstance;
    ...
    if (isinstance) {
        ...
        *out = Set(elts, lineno, col_offset, end_lineno, end_col_offset);
        if (*out == NULL) goto failed;
        return 0;
    }
...
int
obj2ast_expr_context(PyObject* obj, expr_context_ty* out)
{
    int isinstance;
...
int
obj2ast_boolop(PyObject* obj, boolop_ty* out)
{
    int isinstance;
...
int
obj2ast_operator(PyObject* obj, operator_ty* out)
{
    int isinstance;
...
int
obj2ast_unaryop(PyObject* obj, unaryop_ty* out)
{
    int isinstance;
...
int
obj2ast_cmpop(PyObject* obj, cmpop_ty* out)
{
    int isinstance;
...
int
obj2ast_comprehension(PyObject* obj, comprehension_ty* out)
{
    PyObject* tmp = NULL;
    expr_ty target;
    expr_ty iter;
...
int
obj2ast_excepthandler(PyObject* obj, excepthandler_ty* out)
{
    int isinstance;
...
int
obj2ast_arg(PyObject* obj, arg_ty* out)
{
    PyObject* tmp = NULL;
    identifier arg;
    int lineno;
...
int
obj2ast_keyword(PyObject* obj, keyword_ty* out)
{
    PyObject* tmp = NULL;
    identifier arg;
    expr_ty value;
...
int
obj2ast_alias(PyObject* obj, alias_ty* out)
{
    PyObject* tmp = NULL;
    identifier name;
    identifier asname;
...
int
obj2ast_withitem(PyObject* obj, withitem_ty* out)
{
    PyObject* tmp = NULL;
