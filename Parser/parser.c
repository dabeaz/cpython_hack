...
#define _loop1_20_type 1177
#define _tmp_21_type 1178
#define _tmp_22_type 1179
#define _loop0_24_type 1180
#define _gather_23_type 1181
#define _loop0_26_type 1182
#define _gather_25_type 1183
#define _tmp_27_type 1184
#define _loop0_28_type 1185
#define _loop1_29_type 1186
#define _loop0_31_type 1187
#define _gather_30_type 1188
#define _tmp_32_type 1189
...
#define _tmp_40_type 1197
#define _loop1_41_type 1198
#define _tmp_42_type 1199
#define _tmp_43_type 1200
#define _tmp_44_type 1201
#define _tmp_45_type 1202
#define _loop0_46_type 1203
#define _loop0_47_type 1204
#define _loop0_48_type 1205
#define _loop1_49_type 1206
#define _loop0_50_type 1207
#define _loop1_51_type 1208
#define _loop1_52_type 1209
#define _loop1_53_type 1210
#define _loop0_54_type 1211
#define _loop1_55_type 1212
...
#define _tmp_61_type 1218
#define _loop0_63_type 1219
#define _gather_62_type 1220
#define _loop1_64_type 1221
#define _loop0_66_type 1222
#define _gather_65_type 1223
#define _loop1_67_type 1224
#define _loop0_68_type 1225
#define _loop0_69_type 1226
#define _loop0_70_type 1227
#define _loop1_71_type 1228
#define _loop0_72_type 1229
#define _loop1_73_type 1230
#define _loop1_74_type 1231
#define _loop1_75_type 1232
#define _loop0_76_type 1233
#define _loop1_77_type 1234
...
#define _tmp_85_type 1242
#define _loop0_87_type 1243
#define _gather_86_type 1244
#define _tmp_88_type 1245
#define _tmp_89_type 1246
#define _tmp_90_type 1247
#define _tmp_91_type 1248
#define _loop1_92_type 1249
#define _tmp_93_type 1250
#define _tmp_94_type 1251
#define _loop0_96_type 1252
#define _gather_95_type 1253
#define _loop1_97_type 1254
#define _loop0_98_type 1255
#define _tmp_99_type 1256
#define _tmp_100_type 1257
#define _loop0_102_type 1258
#define _gather_101_type 1259
#define _loop0_104_type 1260
#define _gather_103_type 1261
#define _loop0_106_type 1262
#define _gather_105_type 1263
#define _loop0_108_type 1264
#define _gather_107_type 1265
#define _loop0_109_type 1266
#define _loop0_111_type 1267
#define _gather_110_type 1268
#define _tmp_112_type 1269
#define _loop0_114_type 1270
#define _gather_113_type 1271
#define _loop0_116_type 1272
#define _gather_115_type 1273
#define _tmp_117_type 1274
#define _loop0_118_type 1275
#define _tmp_119_type 1276
#define _loop0_120_type 1277
#define _loop0_121_type 1278
#define _tmp_122_type 1279
#define _tmp_123_type 1280
#define _loop0_124_type 1281
...
#define _loop1_142_type 1299
#define _loop1_143_type 1300
...
func_type_comment_rule(Parser *p)
{
    ...
    { // NEWLINE TYPE_COMMENT &(NEWLINE INDENT)
        ...
        if (
            ...
            &&
            _PyPegen_lookahead(1, _tmp_45_rule, p)
        )
        {
...
parameters_rule(Parser *p)
{
    ...
    { // slash_no_default param_no_default* param_with_default* star_etc?
        ...
        if (
            ...
            &&
            (b = _loop0_46_rule(p))  // param_no_default*
            &&
            (c = _loop0_47_rule(p))  // param_with_default*
            &&
    ...
    { // slash_with_default param_with_default* star_etc?
        ...
        if (
            ...
            &&
            (b = _loop0_48_rule(p))  // param_with_default*
            &&
    ...
    { // param_no_default+ param_with_default* star_etc?
        ...
        void *c;
        if (
            (a = _loop1_49_rule(p))  // param_no_default+
            &&
            (b = _loop0_50_rule(p))  // param_with_default*
            &&
            (c = star_etc_rule(p), 1)  // star_etc?
        )
        {
    ...
    { // param_with_default+ star_etc?
        ...
        void *b;
        if (
            (a = _loop1_51_rule(p))  // param_with_default+
            &&
...
slash_no_default_rule(Parser *p)
{
    ...
    { // param_no_default+ '/' &')'
        ...
        asdl_seq * a;
        if (
            (a = _loop1_53_rule(p))  // param_no_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
...
slash_with_default_rule(Parser *p)
{
    ...
    { // param_no_default* param_with_default+ '/' ','
        ...
        asdl_seq * b;
        if (
            (a = _loop0_54_rule(p))  // param_no_default*
            &&
            (b = _loop1_55_rule(p))  // param_with_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
            (_literal_1 = _PyPegen_expect_token(p, 12))  // token=','
    ...
    { // param_no_default* param_with_default+ '/' &')'
        ...
        asdl_seq * b;
        if (
            (a = _loop0_56_rule(p))  // param_no_default*
            &&
            (b = _loop1_57_rule(p))  // param_with_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 8)  // token=')'
...
star_etc_rule(Parser *p)
{
    ...
    { // '*' param_no_default param_maybe_default* kwds?
        ...
        if (
            ...
            &&
            (b = _loop0_58_rule(p))  // param_maybe_default*
            &&
    ...
    { // '*' ',' param_maybe_default+ kwds?
        ...
        if (
            ...
            (_literal_1 = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _loop1_59_rule(p))  // param_maybe_default+
            &&
            (c = kwds_rule(p), 1)  // kwds?
        )
        {
...
decorators_rule(Parser *p)
{
    ...
    { // (('@' named_expression NEWLINE))+
        ...
        asdl_seq * a;
        if (
            (a = _loop1_60_rule(p))  // (('@' named_expression NEWLINE))+
        )
        {
...
expressions_list_rule(Parser *p)
{
    ...
    { // ','.star_expression+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_62_rule(p))  // ','.star_expression+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_expressions_rule(Parser *p)
{
    ...
    { // star_expression ((',' star_expression))+ ','?
        ...
        if (
            ...
            &&
            (b = _loop1_64_rule(p))  // ((',' star_expression))+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_named_expressions_rule(Parser *p)
{
    ...
    { // ','.star_named_expression+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_65_rule(p))  // ','.star_named_expression+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
lambda_parameters_rule(Parser *p)
{
    ...
    { // lambda_slash_no_default lambda_param_no_default* lambda_param_with_default* lambda_star_etc?
        ...
        if (
            ...
            &&
            (b = _loop0_68_rule(p))  // lambda_param_no_default*
            &&
            (c = _loop0_69_rule(p))  // lambda_param_with_default*
            &&
    ...
    { // lambda_slash_with_default lambda_param_with_default* lambda_star_etc?
        ...
        if (
            ...
            &&
            (b = _loop0_70_rule(p))  // lambda_param_with_default*
            &&
    ...
    { // lambda_param_no_default+ lambda_param_with_default* lambda_star_etc?
        ...
        void *c;
        if (
            (a = _loop1_71_rule(p))  // lambda_param_no_default+
            &&
...
lambda_slash_no_default_rule(Parser *p)
{
    ...
    { // lambda_param_no_default+ '/' &':'
        ...
        asdl_seq * a;
        if (
            (a = _loop1_75_rule(p))  // lambda_param_no_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
...
lambda_slash_with_default_rule(Parser *p)
{
    ...
    { // lambda_param_no_default* lambda_param_with_default+ '/' ','
        ...
        asdl_seq * b;
        if (
            (a = _loop0_76_rule(p))  // lambda_param_no_default*
            &&
    ...
    { // lambda_param_no_default* lambda_param_with_default+ '/' &':'
        ...
        asdl_seq * b;
        if (
            (a = _loop0_78_rule(p))  // lambda_param_no_default*
            &&
            (b = _loop1_79_rule(p))  // lambda_param_with_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 11)  // token=':'
...
lambda_star_etc_rule(Parser *p)
{
    ...
    { // '*' lambda_param_no_default lambda_param_maybe_default* lambda_kwds?
        ...
        if (
            ...
            &&
            (b = _loop0_80_rule(p))  // lambda_param_maybe_default*
            &&
    ...
    { // '*' ',' lambda_param_maybe_default+ lambda_kwds?
        ...
        if (
            ...
            (_literal_1 = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _loop1_81_rule(p))  // lambda_param_maybe_default+
            &&
            (c = lambda_kwds_rule(p), 1)  // lambda_kwds?
        )
        {
...
disjunction_rule(Parser *p)
{
    ...
    { // conjunction (('or' conjunction))+
        ...
        if (
            ...
            &&
            (b = _loop1_82_rule(p))  // (('or' conjunction))+
        )
        {
...
conjunction_rule(Parser *p)
{
    ...
    { // inversion (('and' inversion))+
        ...
        if (
            ...
            &&
            (b = _loop1_83_rule(p))  // (('and' inversion))+
        )
        {
...
comparison_rule(Parser *p)
{
    ...
    { // bitwise_or compare_op_bitwise_or_pair+
        ...
        if (
            (a = bitwise_or_rule(p))  // bitwise_or
            &&
            (b = _loop1_84_rule(p))  // compare_op_bitwise_or_pair+
        )
        {
...
atom_rule(Parser *p)
{
    ...
    { // &'(' (tuple | group | genexp)
        ...
        if (
            ...
            &&
            (_tmp_89_var = _tmp_89_rule(p))  // tuple | group | genexp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'(' (tuple | group | genexp)"));
            _res = _tmp_89_var;
    ...
    { // &'[' (list | listcomp)
        ...
        if (
            ...
            &&
            (_tmp_90_var = _tmp_90_rule(p))  // list | listcomp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'[' (list | listcomp)"));
            _res = _tmp_90_var;
    ...
    { // &'{' (dict | set | dictcomp | setcomp)
        ...
        if (
            ...
            &&
            (_tmp_91_var = _tmp_91_rule(p))  // dict | set | dictcomp | setcomp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'{' (dict | set | dictcomp | setcomp)"));
            _res = _tmp_91_var;
...
tuple_rule(Parser *p)
{
    ...
    { // '(' [star_named_expression ',' star_named_expressions?] ')'
        ...
        if (
            (_literal = _PyPegen_expect_token(p, 7))  // token='('
            &&
            (a = _tmp_93_rule(p), 1)  // [star_named_expression ',' star_named_expressions?]
            &&
            (_literal_1 = _PyPegen_expect_token(p, 8))  // token=')'
        )
        {
...
double_starred_kvpairs_rule(Parser *p)
{
    ...
    { // ','.double_starred_kvpair+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_95_rule(p))  // ','.double_starred_kvpair+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
for_if_clauses_rule(Parser *p)
{
    ...
    { // for_if_clause+
        ...
        asdl_seq * _loop1_97_var;
        if (
            (_loop1_97_var = _loop1_97_rule(p))  // for_if_clause+
        )
        {
...
for_if_clause_rule(Parser *p)
{
    ...
    { // 'for' star_targets 'in' disjunction (('if' disjunction))*
        ...
        if (
            ...
            (b = disjunction_rule(p))  // disjunction
            &&
            (c = _loop0_98_rule(p))  // (('if' disjunction))*
        )
        {
...
kwargs_rule(Parser *p)
{
    ...
    { // ','.kwarg_or_starred+ ',' ','.kwarg_or_double_starred+
        ...
        asdl_seq * b;
        if (
            (a = _gather_101_rule(p))  // ','.kwarg_or_starred+
            &&
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _gather_103_rule(p))  // ','.kwarg_or_double_starred+
        )
        {
    ...
    { // ','.kwarg_or_starred+
        ...
        if (
            (_gather_105_var = _gather_105_rule(p))  // ','.kwarg_or_starred+
        )
        {
            D(fprintf(stderr, "%*c+ kwargs[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "','.kwarg_or_starred+"));
            _res = _gather_105_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s kwargs[%d-%d]: %s failed!\n", p->level, ' ',
    ...
    { // ','.kwarg_or_double_starred+
        ...
        if (
            (_gather_107_var = _gather_107_rule(p))  // ','.kwarg_or_double_starred+
        )
        {
            D(fprintf(stderr, "%*c+ kwargs[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "','.kwarg_or_double_starred+"));
            _res = _gather_107_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s kwargs[%d-%d]: %s failed!\n", p->level, ' ',
...
star_targets_rule(Parser *p)
{
    ...
    { // star_target ((',' star_target))* ','?
        ...
        if (
            (a = star_target_rule(p))  // star_target
            &&
            (b = _loop0_109_rule(p))  // ((',' star_target))*
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_targets_seq_rule(Parser *p)
{
    ...
    { // ','.star_target+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_110_rule(p))  // ','.star_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
del_targets_rule(Parser *p)
{
    ...
    { // ','.del_target+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_113_rule(p))  // ','.del_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
incorrect_arguments_rule(Parser *p)
{
    ...
    { // expression for_if_clauses ',' [args | expression for_if_clauses]
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_opt_var = _tmp_117_rule(p), 1)  // [args | expression for_if_clauses]
        )
        {
            D(fprintf(stderr, "%*c+ incorrect_arguments[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "expression for_if_clauses ',' [args | expression for_if_clauses]"));
...
invalid_assignment_rule(Parser *p)
{
    ...
    { // expression ':' expression ['=' annotated_rhs]
        ...
        if (
            ...
            (expression_var = expression_rule(p))  // expression
            &&
            (_opt_var = _tmp_119_rule(p), 1)  // ['=' annotated_rhs]
        )
        {
            D(fprintf(stderr, "%*c+ invalid_assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "expression ':' expression ['=' annotated_rhs]"));
    ...
    { // star_expressions augassign (yield_expr | star_expressions)
        ...
        if (
            ...
            &&
            (_tmp_122_var = _tmp_122_rule(p))  // yield_expr | star_expressions
        )
        {
            D(fprintf(stderr, "%*c+ invalid_assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "star_expressions augassign (yield_expr | star_expressions)"));
...
invalid_parameters_rule(Parser *p)
{
    ...
    { // param_no_default* (slash_with_default | param_with_default+) param_no_default
        ...
        if (
            (_loop0_124_var = _loop0_124_rule(p))  // param_no_default*
            &&
            (_tmp_125_var = _tmp_125_rule(p))  // slash_with_default | param_with_default+
            &&
...
invalid_lambda_parameters_rule(Parser *p)
{
    ...
    { // lambda_param_no_default* (lambda_slash_with_default | lambda_param_with_default+) lambda_param_no_default
        ...
        if (
            (_loop0_126_var = _loop0_126_rule(p))  // lambda_param_no_default*
            &&
            (_tmp_127_var = _tmp_127_rule(p))  // lambda_slash_with_default | lambda_param_with_default+
            &&
...
_loop1_20_rule(Parser *p)
{
    ...
    { // (star_targets '=')
        ...
        void *_tmp_130_var;
        while (
            (_tmp_130_var = _tmp_130_rule(p))  // star_targets '='
        )
        {
            _res = _tmp_130_var;
            if (_n == _children_capacity) {
...
_loop0_50_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop0_50_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop1_55_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop1_55_type, _seq);
    D(p->level--);
    return _seq;
}
...
// _loop1_60: ('@' named_expression NEWLINE)
static asdl_seq *
_loop1_60_rule(Parser *p)
{
    ...
    { // ('@' named_expression NEWLINE)
        ...
        void *_tmp_133_var;
        while (
            (_tmp_133_var = _tmp_133_rule(p))  // '@' named_expression NEWLINE
        )
        {
            _res = _tmp_133_var;
            if (_n == _children_capacity) {
...
// _gather_62: star_expression _loop0_63
static asdl_seq *
_gather_62_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // star_expression _loop0_63
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_62[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_expression _loop0_63"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = star_expression_rule(p))  // star_expression
        ...
        D(fprintf(stderr, "%*c%s _gather_62[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_expression _loop0_63"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop1_64_rule(Parser *p)
{
    ...
    { // (',' star_expression)
        ...
        void *_tmp_134_var;
        while (
            (_tmp_134_var = _tmp_134_rule(p))  // ',' star_expression
        )
        {
            _res = _tmp_134_var;
            if (_n == _children_capacity) {
...
_gather_65_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // star_named_expression _loop0_66
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_65[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_named_expression _loop0_66"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = star_named_expression_rule(p))  // star_named_expression
        ...
        D(fprintf(stderr, "%*c%s _gather_65[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_named_expression _loop0_66"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop1_67_rule(Parser *p)
{
    ...
    { // (',' expression)
        ...
        void *_tmp_135_var;
        while (
            (_tmp_135_var = _tmp_135_rule(p))  // ',' expression
        )
        {
            _res = _tmp_135_var;
            if (_n == _children_capacity) {
...
// _loop0_68: lambda_param_no_default
static asdl_seq *
...
// _loop1_71: lambda_param_no_default
static asdl_seq *
...
// _loop0_78: lambda_param_no_default
static asdl_seq *
...
// _loop0_80: lambda_param_maybe_default
static asdl_seq *
...
// _loop1_81: lambda_param_maybe_default
static asdl_seq *
...
_loop1_82_rule(Parser *p)
{
    ...
    { // ('or' conjunction)
        ...
        void *_tmp_136_var;
        while (
            (_tmp_136_var = _tmp_136_rule(p))  // 'or' conjunction
        )
        {
            _res = _tmp_136_var;
            if (_n == _children_capacity) {
...
_loop1_83_rule(Parser *p)
{
    ...
    { // ('and' inversion)
        ...
        void *_tmp_137_var;
        while (
            (_tmp_137_var = _tmp_137_rule(p))  // 'and' inversion
        )
        {
            _res = _tmp_137_var;
            if (_n == _children_capacity) {
...
// _loop1_84: compare_op_bitwise_or_pair
static asdl_seq *
...
_gather_86_rule(Parser *p)
{
    ...
    { // slice _loop0_87
        ...
        D(fprintf(stderr, "%*c> _gather_86[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "slice _loop0_87"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = slice_rule(p))  // slice
        ...
        D(fprintf(stderr, "%*c%s _gather_86[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "slice _loop0_87"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_95_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // double_starred_kvpair _loop0_96
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_95[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "double_starred_kvpair _loop0_96"));
        KeyValuePair* elem;
        asdl_seq * seq;
        if (
            (elem = double_starred_kvpair_rule(p))  // double_starred_kvpair
        ...
        D(fprintf(stderr, "%*c%s _gather_95[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "double_starred_kvpair _loop0_96"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop0_98_rule(Parser *p)
{
    ...
    { // ('if' disjunction)
        ...
        void *_tmp_138_var;
        while (
            (_tmp_138_var = _tmp_138_rule(p))  // 'if' disjunction
        )
        {
            _res = _tmp_138_var;
            if (_n == _children_capacity) {
...
_gather_101_rule(Parser *p)
{
    ...
    { // kwarg_or_starred _loop0_102
        ...
        D(fprintf(stderr, "%*c> _gather_101[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "kwarg_or_starred _loop0_102"));
        KeywordOrStarred* elem;
        asdl_seq * seq;
        if (
            (elem = kwarg_or_starred_rule(p))  // kwarg_or_starred
        ...
        D(fprintf(stderr, "%*c%s _gather_101[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "kwarg_or_starred _loop0_102"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_103_rule(Parser *p)
{
    ...
    { // kwarg_or_double_starred _loop0_104
        ...
        D(fprintf(stderr, "%*c> _gather_103[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "kwarg_or_double_starred _loop0_104"));
        KeywordOrStarred* elem;
        asdl_seq * seq;
        if (
            (elem = kwarg_or_double_starred_rule(p))  // kwarg_or_double_starred
        ...
        D(fprintf(stderr, "%*c%s _gather_103[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "kwarg_or_double_starred _loop0_104"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_105_rule(Parser *p)
{
    ...
    { // kwarg_or_starred _loop0_106
        ...
        D(fprintf(stderr, "%*c> _gather_105[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "kwarg_or_starred _loop0_106"));
        KeywordOrStarred* elem;
        asdl_seq * seq;
        if (
            (elem = kwarg_or_starred_rule(p))  // kwarg_or_starred
        ...
        D(fprintf(stderr, "%*c%s _gather_105[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "kwarg_or_starred _loop0_106"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_107_rule(Parser *p)
{
    ...
    { // kwarg_or_double_starred _loop0_108
        ...
        D(fprintf(stderr, "%*c> _gather_107[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "kwarg_or_double_starred _loop0_108"));
        KeywordOrStarred* elem;
        asdl_seq * seq;
        if (
            (elem = kwarg_or_double_starred_rule(p))  // kwarg_or_double_starred
        ...
        D(fprintf(stderr, "%*c%s _gather_107[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "kwarg_or_double_starred _loop0_108"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop0_109_rule(Parser *p)
{
    ...
    { // (',' star_target)
        ...
        void *_tmp_139_var;
        while (
            (_tmp_139_var = _tmp_139_rule(p))  // ',' star_target
        )
        {
            _res = _tmp_139_var;
            if (_n == _children_capacity) {
...
_gather_110_rule(Parser *p)
{
    ...
    { // star_target _loop0_111
        ...
        D(fprintf(stderr, "%*c> _gather_110[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_target _loop0_111"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = star_target_rule(p))  // star_target
        ...
        D(fprintf(stderr, "%*c%s _gather_110[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_target _loop0_111"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_113_rule(Parser *p)
{
    ...
    { // del_target _loop0_114
        ...
        D(fprintf(stderr, "%*c> _gather_113[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "del_target _loop0_114"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = del_target_rule(p))  // del_target
        ...
        D(fprintf(stderr, "%*c%s _gather_113[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "del_target _loop0_114"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_115_rule(Parser *p)
{
    ...
    { // target _loop0_116
        ...
        D(fprintf(stderr, "%*c> _gather_115[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "target _loop0_116"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = target_rule(p))  // target
        ...
        D(fprintf(stderr, "%*c%s _gather_115[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "target _loop0_116"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop0_121_rule(Parser *p)
{
    ...
    { // (star_targets '=')
        ...
        void *_tmp_141_var;
        while (
            (_tmp_141_var = _tmp_141_rule(p))  // star_targets '='
        )
        {
            _res = _tmp_141_var;
            if (_n == _children_capacity) {
...
// _tmp_122: yield_expr | star_expressions
static void *
...
// _tmp_125: slash_with_default | param_with_default+
static void *
_tmp_125_rule(Parser *p)
{
    ...
    { // param_with_default+
        ...
        if (
            (_loop1_142_var = _loop1_142_rule(p))  // param_with_default+
        )
        {
            D(fprintf(stderr, "%*c+ _tmp_125[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "param_with_default+"));
            _res = _loop1_142_var;
...
// _tmp_127: lambda_slash_with_default | lambda_param_with_default+
static void *
_tmp_127_rule(Parser *p)
{
    ...
    { // lambda_param_with_default+
        ...
        if (
            (_loop1_143_var = _loop1_143_rule(p))  // lambda_param_with_default+
        )
        {
            D(fprintf(stderr, "%*c+ _tmp_127[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "lambda_param_with_default+"));
            _res = _loop1_143_var;
...
_tmp_129_rule(Parser *p)
{
    ...
    { // ',' (':' | '**')
        ...
        {
            D(fprintf(stderr, "%*c+ _tmp_129[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "',' (':' | '**')"));
            _res = _PyPegen_dummy_name(p, _literal, _tmp_145_var);
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _tmp_129[%d-%d]: %s failed!\n", p->level, ' ',
...
// _tmp_133: '@' named_expression NEWLINE
static void *
...
_loop1_143_rule(Parser *p)
{
    ...
    { // lambda_param_with_default
        ...
        D(fprintf(stderr, "%*c> _loop1_143[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "lambda_param_with_default"));
        NameDefaultPair* lambda_param_with_default_var;
        while (
            (lambda_param_with_default_var = lambda_param_with_default_rule(p))  // lambda_param_with_default
        )
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _loop1_143[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "lambda_param_with_default"));
    }
    if (_n == 0 || p->error_indicator) {
        PyMem_Free(_children);
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop1_143_type, _seq);
    D(p->level--);
    return _seq;
}
