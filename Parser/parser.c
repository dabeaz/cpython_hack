...
#define _loop0_72_type 1224
#define _gather_71_type 1225
#define _tmp_73_type 1226
#define _tmp_74_type 1227
#define _tmp_75_type 1228
#define _tmp_76_type 1229
#define _loop1_77_type 1230
#define _tmp_78_type 1231
#define _tmp_79_type 1232
#define _loop0_81_type 1233
#define _gather_80_type 1234
#define _loop1_82_type 1235
#define _loop0_83_type 1236
#define _tmp_84_type 1237
#define _tmp_85_type 1238
#define _loop0_87_type 1239
#define _gather_86_type 1240
#define _loop0_89_type 1241
#define _gather_88_type 1242
#define _loop0_91_type 1243
#define _gather_90_type 1244
#define _loop0_93_type 1245
#define _gather_92_type 1246
#define _loop0_94_type 1247
#define _loop0_96_type 1248
#define _gather_95_type 1249
#define _tmp_97_type 1250
#define _loop0_99_type 1251
#define _gather_98_type 1252
#define _loop0_101_type 1253
#define _gather_100_type 1254
#define _tmp_102_type 1255
#define _loop0_103_type 1256
#define _tmp_104_type 1257
#define _loop0_105_type 1258
#define _loop0_106_type 1259
#define _tmp_107_type 1260
#define _tmp_108_type 1261
#define _loop0_109_type 1262
#define _tmp_110_type 1263
#define _loop0_111_type 1264
#define _tmp_112_type 1265
...
atom_rule(Parser *p)
{
    ...
    { // &'(' (tuple | group | genexp)
        ...
        if (
            ...
            &&
            (_tmp_74_var = _tmp_74_rule(p))  // tuple | group | genexp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'(' (tuple | group | genexp)"));
            _res = _tmp_74_var;
    ...
    { // &'[' (list | listcomp)
        ...
        if (
            ...
            &&
            (_tmp_75_var = _tmp_75_rule(p))  // list | listcomp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'[' (list | listcomp)"));
            _res = _tmp_75_var;
    ...
    { // &'{' (dict | set | dictcomp | setcomp)
        ...
        if (
            ...
            &&
            (_tmp_76_var = _tmp_76_rule(p))  // dict | set | dictcomp | setcomp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'{' (dict | set | dictcomp | setcomp)"));
            _res = _tmp_76_var;
...
tuple_rule(Parser *p)
{
    ...
    { // '(' [star_named_expression ',' star_named_expressions?] ')'
        ...
        if (
            (_literal = _PyPegen_expect_token(p, 7))  // token='('
            &&
            (a = _tmp_78_rule(p), 1)  // [star_named_expression ',' star_named_expressions?]
            &&
            (_literal_1 = _PyPegen_expect_token(p, 8))  // token=')'
        )
        {
...
group_rule(Parser *p)
{
    ...
    { // '(' (yield_expr | named_expression) ')'
        ...
        if (
            (_literal = _PyPegen_expect_token(p, 7))  // token='('
            &&
            (a = _tmp_79_rule(p))  // yield_expr | named_expression
            &&
            (_literal_1 = _PyPegen_expect_token(p, 8))  // token=')'
        )
        {
...
double_starred_kvpairs_rule(Parser *p)
{
    ...
    { // ','.double_starred_kvpair+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_80_rule(p))  // ','.double_starred_kvpair+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
for_if_clauses_rule(Parser *p)
{
    ...
    { // for_if_clause+
        ...
        asdl_seq * _loop1_82_var;
        if (
            (_loop1_82_var = _loop1_82_rule(p))  // for_if_clause+
        )
        {
...
for_if_clause_rule(Parser *p)
{
    ...
    { // 'for' star_targets 'in' disjunction (('if' disjunction))*
        ...
        if (
            ...
            (b = disjunction_rule(p))  // disjunction
            &&
            (c = _loop0_83_rule(p))  // (('if' disjunction))*
        )
        {
...
kwargs_rule(Parser *p)
{
    ...
    { // ','.kwarg_or_starred+ ',' ','.kwarg_or_double_starred+
        ...
        asdl_seq * b;
        if (
            (a = _gather_86_rule(p))  // ','.kwarg_or_starred+
            &&
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _gather_88_rule(p))  // ','.kwarg_or_double_starred+
        )
        {
...
star_targets_seq_rule(Parser *p)
{
    ...
    { // ','.star_target+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_95_rule(p))  // ','.star_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
del_targets_rule(Parser *p)
{
    ...
    { // ','.del_target+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_98_rule(p))  // ','.del_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
incorrect_arguments_rule(Parser *p)
{
    ...
    { // expression for_if_clauses ',' [args | expression for_if_clauses]
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_opt_var = _tmp_102_rule(p), 1)  // [args | expression for_if_clauses]
        )
        {
            D(fprintf(stderr, "%*c+ incorrect_arguments[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "expression for_if_clauses ',' [args | expression for_if_clauses]"));
...
invalid_assignment_rule(Parser *p)
{
    ...
    { // star_named_expression ',' star_named_expressions* ':'
        ...
        if (
            ...
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_loop0_103_var = _loop0_103_rule(p))  // star_named_expressions*
            &&
    ...
    { // expression ':' expression ['=' annotated_rhs]
        ...
        if (
            ...
            (expression_var = expression_rule(p))  // expression
            &&
            (_opt_var = _tmp_104_rule(p), 1)  // ['=' annotated_rhs]
        )
        {
            D(fprintf(stderr, "%*c+ invalid_assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "expression ':' expression ['=' annotated_rhs]"));
    ...
    { // ((star_targets '='))* star_expressions '='
        ...
        Token * _literal;
        asdl_seq * _loop0_105_var;
        expr_ty a;
        if (
            (_loop0_105_var = _loop0_105_rule(p))  // ((star_targets '='))*
            &&
    ...
    { // star_expressions augassign (yield_expr | star_expressions)
        ...
        if (
            ...
            &&
            (_tmp_107_var = _tmp_107_rule(p))  // yield_expr | star_expressions
        )
        {
            D(fprintf(stderr, "%*c+ invalid_assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "star_expressions augassign (yield_expr | star_expressions)"));
...
invalid_parameters_rule(Parser *p)
{
    ...
    { // param_no_default* (slash_with_default | param_with_default+) param_no_default
        ...
        asdl_seq * _loop0_109_var;
        void *_tmp_110_var;
        arg_ty param_no_default_var;
        if (
            (_loop0_109_var = _loop0_109_rule(p))  // param_no_default*
            &&
            (_tmp_110_var = _tmp_110_rule(p))  // slash_with_default | param_with_default+
            &&
...
invalid_lambda_parameters_rule(Parser *p)
{
    ...
    { // lambda_param_no_default* (lambda_slash_with_default | lambda_param_with_default+) lambda_param_no_default
        ...
        asdl_seq * _loop0_111_var;
        void *_tmp_112_var;
        arg_ty lambda_param_no_default_var;
        if (
            (_loop0_111_var = _loop0_111_rule(p))  // lambda_param_no_default*
            &&
            (_tmp_112_var = _tmp_112_rule(p))  // lambda_slash_with_default | lambda_param_with_default+
            &&
...
_loop1_8_rule(Parser *p)
{
    ...
    { // (star_targets '=')
        ...
        void *_tmp_115_var;
        while (
            (_tmp_115_var = _tmp_115_rule(p))  // star_targets '='
        )
        {
            _res = _tmp_115_var;
            if (_n == _children_capacity) {
...
_loop1_46_rule(Parser *p)
{
    ...
    { // ('@' named_expression NEWLINE)
        ...
        void *_tmp_118_var;
        while (
            (_tmp_118_var = _tmp_118_rule(p))  // '@' named_expression NEWLINE
        )
        {
            _res = _tmp_118_var;
            if (_n == _children_capacity) {
...
_loop1_50_rule(Parser *p)
{
    ...
    { // (',' star_expression)
        ...
        void *_tmp_119_var;
        while (
            (_tmp_119_var = _tmp_119_rule(p))  // ',' star_expression
        )
        {
            _res = _tmp_119_var;
            if (_n == _children_capacity) {
...
_loop1_53_rule(Parser *p)
{
    ...
    { // (',' expression)
        ...
        void *_tmp_120_var;
        while (
            (_tmp_120_var = _tmp_120_rule(p))  // ',' expression
        )
        {
            _res = _tmp_120_var;
            if (_n == _children_capacity) {
...
_loop1_68_rule(Parser *p)
{
    ...
    { // ('or' conjunction)
        ...
        void *_tmp_121_var;
        while (
            (_tmp_121_var = _tmp_121_rule(p))  // 'or' conjunction
        )
        {
            _res = _tmp_121_var;
            if (_n == _children_capacity) {
...
_loop1_69_rule(Parser *p)
{
    ...
    { // ('and' inversion)
        ...
        void *_tmp_122_var;
        while (
            (_tmp_122_var = _tmp_122_rule(p))  // 'and' inversion
        )
        {
            _res = _tmp_122_var;
            if (_n == _children_capacity) {
...
_gather_71_rule(Parser *p)
{
    ...
    { // slice _loop0_72
        ...
        D(fprintf(stderr, "%*c> _gather_71[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "slice _loop0_72"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = slice_rule(p))  // slice
        ...
        D(fprintf(stderr, "%*c%s _gather_71[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "slice _loop0_72"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _tmp_76: dict | set | dictcomp | setcomp
static void *
...
_tmp_78_rule(Parser *p)
{
    ...
    { // star_named_expression ',' star_named_expressions?
        ...
        D(fprintf(stderr, "%*c> _tmp_78[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_named_expression ',' star_named_expressions?"));
        Token * _literal;
        expr_ty y;
        void *z;
        if (
        ...
        {
            D(fprintf(stderr, "%*c+ _tmp_78[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "star_named_expression ',' star_named_expressions?"));
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _tmp_78[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_named_expression ',' star_named_expressions?"));
    }
    _res = NULL;
  done:
...
// _tmp_79: yield_expr | named_expression
static void *
...
_loop0_81_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop0_81_type, _seq);
    D(p->level--);
    return _seq;
}

// _gather_80: double_starred_kvpair _loop0_81
static asdl_seq *
...
_loop0_83_rule(Parser *p)
{
    ...
    { // ('if' disjunction)
        ...
        void *_tmp_123_var;
        while (
            (_tmp_123_var = _tmp_123_rule(p))  // 'if' disjunction
        )
        {
            _res = _tmp_123_var;
            if (_n == _children_capacity) {
...
// _gather_86: kwarg_or_starred _loop0_87
static asdl_seq *
_gather_86_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // kwarg_or_starred _loop0_87
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_86[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "kwarg_or_starred _loop0_87"));
        KeywordOrStarred* elem;
        asdl_seq * seq;
        if (
            (elem = kwarg_or_starred_rule(p))  // kwarg_or_starred
        ...
        D(fprintf(stderr, "%*c%s _gather_86[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "kwarg_or_starred _loop0_87"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _loop0_89: ',' kwarg_or_double_starred
static asdl_seq *
...
// _gather_88: kwarg_or_double_starred _loop0_89
static asdl_seq *
_gather_88_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // kwarg_or_double_starred _loop0_89
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_88[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "kwarg_or_double_starred _loop0_89"));
        KeywordOrStarred* elem;
        asdl_seq * seq;
        if (
            (elem = kwarg_or_double_starred_rule(p))  // kwarg_or_double_starred
        ...
        D(fprintf(stderr, "%*c%s _gather_88[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "kwarg_or_double_starred _loop0_89"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _gather_90: kwarg_or_starred _loop0_91
static asdl_seq *
...
// _gather_92: kwarg_or_double_starred _loop0_93
static asdl_seq *
...
_loop0_94_rule(Parser *p)
{
    ...
    { // (',' star_target)
        ...
        void *_tmp_124_var;
        while (
            (_tmp_124_var = _tmp_124_rule(p))  // ',' star_target
        )
        {
            _res = _tmp_124_var;
            if (_n == _children_capacity) {
...
// _gather_95: star_target _loop0_96
static asdl_seq *
...
// _gather_98: del_target _loop0_99
static asdl_seq *
...
_loop0_101_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop0_101_type, _seq);
    D(p->level--);
    return _seq;
}

// _gather_100: target _loop0_101
static asdl_seq *
_gather_100_rule(Parser *p)
{
    ...
    { // target _loop0_101
        ...
        D(fprintf(stderr, "%*c> _gather_100[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "target _loop0_101"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = target_rule(p))  // target
        ...
        D(fprintf(stderr, "%*c%s _gather_100[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "target _loop0_101"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _tmp_102: args | expression for_if_clauses
static void *
...
// _loop0_103: star_named_expressions
static asdl_seq *
...
_loop0_105_rule(Parser *p)
{
    ...
    { // (star_targets '=')
        ...
        void *_tmp_125_var;
        while (
            (_tmp_125_var = _tmp_125_rule(p))  // star_targets '='
        )
        {
            _res = _tmp_125_var;
            if (_n == _children_capacity) {
...
// _tmp_107: yield_expr | star_expressions
static void *
...
// _tmp_110: slash_with_default | param_with_default+
static void *
_tmp_110_rule(Parser *p)
{
    ...
    { // param_with_default+
        ...
        D(fprintf(stderr, "%*c> _tmp_110[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "param_with_default+"));
        asdl_seq * _loop1_127_var;
        if (
            (_loop1_127_var = _loop1_127_rule(p))  // param_with_default+
        )
        {
            D(fprintf(stderr, "%*c+ _tmp_110[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "param_with_default+"));
            _res = _loop1_127_var;
...
// _loop0_111: lambda_param_no_default
static asdl_seq *
...
// _tmp_112: lambda_slash_with_default | lambda_param_with_default+
static void *
_tmp_112_rule(Parser *p)
{
    ...
    { // lambda_param_with_default+
        ...
        if (
            (_loop1_128_var = _loop1_128_rule(p))  // lambda_param_with_default+
        )
        {
            D(fprintf(stderr, "%*c+ _tmp_112[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "lambda_param_with_default+"));
            _res = _loop1_128_var;
...
_tmp_113_rule(Parser *p)
{
    ...
    { // ',' (')' | '**')
        ...
        {
            D(fprintf(stderr, "%*c+ _tmp_113[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "',' (')' | '**')"));
            _res = _PyPegen_dummy_name(p, _literal, _tmp_129_var);
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _tmp_113[%d-%d]: %s failed!\n", p->level, ' ',
...
_loop1_127_rule(Parser *p)
{
    ...
    { // param_with_default
        ...
        D(fprintf(stderr, "%*c> _loop1_127[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "param_with_default"));
        NameDefaultPair* param_with_default_var;
        while (
            (param_with_default_var = param_with_default_rule(p))  // param_with_default
        )
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _loop1_127[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "param_with_default"));
    }
    if (_n == 0 || p->error_indicator) {
        PyMem_Free(_children);
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop1_127_type, _seq);
    D(p->level--);
    return _seq;
}
